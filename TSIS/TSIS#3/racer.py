...
# LOAD IMAGES
road_img = pygame.image.load(os.path.join(IMAGES_DIR, "road.png")).convert()
...
npc_images = []
for i in range(1, 10):
    img = pygame.image.load(os.path.join(IMAGES_DIR, f"NPC{i}.png")).convert_alpha()
...
coin_images = {
    1: pygame.transform.scale(
        pygame.image.load(os.path.join(IMAGES_DIR, "1coin.png")).convert_alpha(), (40, 40)
    ),
    3: pygame.transform.scale(
        pygame.image.load(os.path.join(IMAGES_DIR, "3coin.png")).convert_alpha(), (40, 40)
    ),
    5: pygame.transform.scale(
        pygame.image.load(os.path.join(IMAGES_DIR, "5coin.png")).convert_alpha(), (40, 40)
    ),
}
